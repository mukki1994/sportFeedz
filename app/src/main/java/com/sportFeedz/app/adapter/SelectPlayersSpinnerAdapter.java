...
public class SelectPlayersSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public SelectPlayersSpinnerAdapter(Activity activitySpinner, int textViewResourceId, ArrayList objects,
                                       Resources resLocal
    ) {
